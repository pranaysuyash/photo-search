...
function isStaticAsset(url) {
	return /(\.((css|js|mjs|wasm|map|png|jpg|jpeg|gif|svg|webp|ico|ttf|woff2?)))(\?.*)?$/i.test(
		url,
	);
}
...
function isJsonApi(url) {
	...
	return /\/(library|collections|trips|smart_collections|presets|favorites|tags|saved|metadata|map|faces|ocr|workspace|videos)(\?|\/|$)/.test(
		url,
	);
}
