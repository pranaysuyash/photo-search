...
interface ActionsContextType {
  ...
  searchLike: (path: string, text?: string, weight?: number, topK?: number) => Promise<void>;
  ...
  handlePhotoAction: (action: string, photo: { path: string; [key: string]: unknown }) => void;
...
export const ActionsProvider: React.FC<ActionsProviderProps> = ({ children, value }) => {
