...
const Ctx = createContext<{ state: SettingsState; actions: SettingsActions } | null>(null)
...
export function SettingsProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo(() => ({
    ...
    actions: { setEngine, setUseFast, setFastKind, setUseCaptions, setUseOcr, setTopK },
...
export function useSettingsContext() {
  ...
  if (!v) throw new Error('useSettingsContext must be used within SettingsProvider')
  return v
}
