...
describe("PerformanceProfiler", () => {
	...
	describe("Profile Management", () => {
		it("should retrieve performance profile", async () => {
			...
			await performanceProfiler.profileBackend(
				mockBackend,
				"face_detection",
				"model1",
				1,
			...
			// Then retrieve it
			const profile = performanceProfiler.getPerformanceProfile(
				"mock-backend",
				"face_detection",
				"model1",
			);
	...
	describe("Backend Comparison", () => {
		it("should compare backends successfully", async () => {
			...
			const comparison = performanceProfiler.compareBackends(
				["mock-backend"],
				"face_detection",
				"model1",
			);
	...
	describe("Optimization Recommendations", () => {
		it("should generate optimization recommendations", async () => {
			...
			const recommendations =
				performanceProfiler.generateOptimizationRecommendations("mock-backend");
		...
		it("should handle backend without recommendations", () => {
			const recommendations =
				performanceProfiler.generateOptimizationRecommendations("non-existent");
		...
		it("should prioritize recommendations correctly", async () => {
			...
			const recommendations =
				performanceProfiler.generateOptimizationRecommendations("poor-backend");
			...
			if (recommendations.length > 1) {
				for (let i = 0; i < recommendations.length - 1; i++) {
					...
					expect(priorityOrder[currentPriority]).toBeGreaterThanOrEqual(
	...
	describe("Profile Import/Export", () => {
		...
		it("should import profiles", async () => {
			...
			const profile = newProfiler.getPerformanceProfile(
				"mock-backend",
				"face_detection",
				"model1",
			);
	...
	describe("Performance Calculations", () => {
		it("should calculate performance scores correctly", async () => {
			...
			const scores = (performanceProfiler as any).calculatePerformanceScores(
				profile,
			);
		...
		it("should analyze performance trends", async () => {
			...
			const trends = (performanceProfiler as any).analyzePerformanceTrends(
				"mock-backend",
			);
