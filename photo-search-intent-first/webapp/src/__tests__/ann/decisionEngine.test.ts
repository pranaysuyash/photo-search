...
describe('DecisionEngine', () => {
  ...
  describe('Decision Making', () => {
    ...
    it('should record task results', () => {
      ...
      const result = {
        taskId,
        output: { data: 'result', format: { type: 'tensor', dtype: 'float32' }, processingTime: 100 },
        backend: backendId,
        processingTime: 100,
        memoryUsage: 50,
        success: true
  ...
  describe('Scoring Logic', () => {
    it('should calculate candidate scores correctly', async () => {
      const candidates = [
        { backendId: 'mock-backend', confidence: 0.8 }
      ];
      ...
      const scoredCandidates = await (decisionEngine as any).scoreCandidates(candidates, context);
    ...
    it('should calculate performance score correctly', () => {
      ...
      const performanceScore = (decisionEngine as any).calculatePerformanceScore(backendId, context);
    ...
    it('should calculate reliability score correctly', () => {
      ...
      const reliabilityScore = (decisionEngine as any).calculateReliabilityScore(backendHealth);
    ...
    it('should calculate efficiency score correctly', () => {
      ...
      const efficiencyScore = (decisionEngine as any).calculateEfficiencyScore(backendId, context);
  ...
  describe('Fairness Constraints', () => {
    it('should apply fairness constraints', async () => {
      ...
      const fairSelection = (decisionEngine as any).applyFairnessConstraints(selected, candidates, context);
  ...
  describe('Weight Perturbation', () => {
    it('should perturb weights correctly', () => {
      ...
      const perturbedWeights = (decisionEngine as any).perturbWeights(originalWeights);
