...
export const LAYOUT_PATTERNS = {
	...
	container:
		"w-full max-w-7xl mx-auto px-2 sm:px-3 md:px-6 lg:px-8 xl:px-10 2xl:px-12",

	// Centered content container
	centered:
		"flex items-center justify-center min-h-screen p-2 sm:p-3 md:p-6 lg:p-8",
	...
	// Sticky header
	stickyHeader:
		"sticky top-0 z-50 bg-background border-b border-border shadow-sm px-2 py-2 sm:px-3 sm:py-3 md:px-6 md:py-4 lg:px-8 lg:py-5",

	// Sidebar layout
	sidebar:
		"hidden md:flex md:w-64 lg:w-80 xl:w-96 flex-shrink-0 border-r border-border bg-muted/30",
...
export const RESPONSIVE_CLASSES = {
	...
	pageHeader:
		"px-2 py-2 sm:px-3 sm:py-3 md:px-6 md:py-4 lg:px-8 lg:py-5 xl:px-10 xl:py-6 2xl:px-12 2xl:py-8",
...
export const COMPONENT_SPACING = {
	...
	modal: {
		container:
			"fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-3 md:p-6 lg:p-8",
		backdrop: "fixed inset-0 bg-black/40 backdrop-blur-sm z-40",
		content:
			"relative bg-background border border-border rounded-lg shadow-lg w-full max-w-md mx-auto p-4 sm:p-6 md:p-8 lg:p-10",
		header:
			"flex items-center justify-between pb-4 mb-4 border-b border-border",
		body: "space-y-4",
		footer:
			"flex items-center justify-end space-x-2 pt-4 mt-4 border-t border-border",
	},
	...
	form: {
		...
		input:
			"w-full px-3 py-2 sm:px-4 sm:py-3 border border-border rounded-md bg-background text-foreground",
