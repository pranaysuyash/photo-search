...
import type { OnboardingStep } from "./hooks/useOnboardingFlows";
...
<<<<<<< Updated upstream
  ...
  const { doSearchImmediate } = useSearchOperations({
    ...
    setResults: (results: unknown[]) =>
      photoActions.setResults(results as SearchResult[]),
...
=======
	...
	const { doSearchImmediate } = useSearchOperations({
		...
		setDir: settingsActions.setDir,
		setQuery: photoActions.setQuery,
		setResults: (results: unknown[]) => photoActions.setResults(results as SearchResult[]),
		setSearchId: photoActions.setSearchId,
		setBusy: uiActions.setBusy,
		setNote: uiActions.setNote,
		completeOnboardingStep,
