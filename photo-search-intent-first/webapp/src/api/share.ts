...
export class ShareAPI {
  static async createShare(params: CreateShareParams): Promise<CreateShareResponse> {
  ...
  static async getShare(token: string): Promise<{ paths: string[]; expires?: string; view_only?: boolean }> {
  ...
  static async listShares(dir: string): Promise<Array<{ token: string; paths: string[]; expires?: string; created_at: string }>> {
