...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'The main search bar component for photo searching with natural language queries.'
      }
    }
  },
  tags: ['autodocs'],
...
export const LongQuery: Story = {
  args: {
    onSearchNow: action('search'),
    initialQuery: 'Find all photos from my summer vacation in Hawaii with palm trees and sunset on the beach',
  },
};
