...
import { useSettingsStore, useNeedsHf, useNeedsOAI } from './settingsStore'

describe('settingsStore', () => {
  beforeEach(() => {
    useSettingsStore.setState({
      dir: '', engine: 'local', hfToken: '', openaiKey: '',
      useFast: false, fastKind: '', useCaps: false, vlmModel: 'Qwen/Qwen2-VL-2B-Instruct',
      useOcr: false, hasText: false,
  ...
  it('defaults are sensible', () => {
    ...
    expect({ camera: s.camera, isoMin: s.isoMin, isoMax: s.isoMax, fMin: s.fMin, fMax: s.fMax, place: s.place }).toEqual({ camera: '', isoMin: '', isoMax: '', fMin: '', fMax: '', place: '' })
  })
