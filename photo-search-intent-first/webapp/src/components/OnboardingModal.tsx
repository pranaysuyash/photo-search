...
import { FolderOpen, Search, Camera, Sparkles, ArrowRight, X, CheckCircle, PartyPopper } from 'lucide-react'
...
export function OnboardingModal({ show, onComplete, onSelectDirectory }: OnboardingModalProps) {
  ...
  const steps = [
    {
      ...
      description: "No more endless scrolling! Just describe what you're looking for and we'll find it. Ready to get started?",
      action: null,
      celebration: false
    },
    {
      ...
      description: "Pick the folder where you keep your photos - we'll help make them searchable.",
      action: {
    ...
    },
    {
      ...
      description: "Give us a few minutes to understand what's in your photos so you can search naturally.",
      action: null,
      celebration: false
    },
    {
      ...
      description: "Try searching for anything - like 'that trip to the beach' or 'kids playing in the backyard'. Just type what you remember!",
      action: null,
      celebration: true
    }
  ]
