...
export function VisualTools({
	...
	const [selectedImagesForTools, setSelectedImagesForTools] = useState<string[]>(selectedImages);
		...
		<div className="visual-tools">
			...
			<div className="tools-header">
				<div className="tools-title">
					...
					<div>
						<h2 className="text-xl font-semibold">Visual Analysis & Creative Tools</h2>
				...
				<Card>
					...
					<CardContent>
						<div className="tools-grid">
							<div
								className={`tool-card ${activeTab === 'editor' ? 'active' : ''}`}
							...
							>
								...
								<div className="tool-info">
									...
									<p className="text-xs text-muted-foreground">
										Apply filters, adjustments, and creative effects to your photos
									</p>
							...
							<div
								className={`tool-card ${activeTab === 'similarity' ? 'active' : ''}`}
							...
							<Card>
								<CardContent className="flex flex-col items-center justify-center py-12">
									...
									<p className="text-sm text-muted-foreground text-center mb-4">
										Select an image from your library to start using the Creative Editor
									</p>
