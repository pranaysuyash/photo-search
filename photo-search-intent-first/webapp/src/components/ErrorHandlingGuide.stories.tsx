    ...
    const handleClick = () => {
      try {
        ...
        handleError(error, {
          ...
          fallbackMessage: "An error occurred while simulating an error (ironic, isn't it?)"
        });
      }
    };
  ...
  render: () => {
    ...
    return (
      <div className="p-6 max-w-md">
        ...
        <p className="mb-4 text-gray-600">
          This example shows how Error Boundaries catch and handle component errors.
        </p>
  ...
  render: () => {
    ...
    const customFallback = (
      <div className="p-4 bg-yellow-100 border border-yellow-300 rounded">
        ...
        <p className="text-yellow-700">Something went wrong, but we're showing a custom message.</p>
        <Button 
    ...
    return (
      <div className="p-6 max-w-md">
        ...
        <p className="mb-4 text-gray-600">
          This example shows how to provide custom fallback UI for Error Boundaries.
        </p>
        <ErrorBoundary 
