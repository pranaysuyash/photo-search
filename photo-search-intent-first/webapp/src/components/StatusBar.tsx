...
import { 
  HardDrive, Image, Search, Cpu, Wifi, WifiOff, 
      ...
      <div className="status-content">
        ...
        <div className="status-section">
          ...
          <div className="status-item">
            ...
            <span className="status-text">{formatDirectory(currentDirectory)}</span>
          </div>
          ...
          {isIndexing ? (
            <div className="status-item">
              ...
              <span className="status-text processing">Indexing... {indexedCount}/{photoCount}</span>
            </div>
          ) : (
            <div className="status-item">
              <CheckCircle className="status-icon" />
              <span className="status-text success">{indexedCount.toLocaleString()} indexed</span>
            </div>
          )}
        </div>
        ...
        <div className="status-section">
          ...
          {activeJobs > 0 && (
            <div className="status-item">
              ...
              <span className="status-text warning">{activeJobs} active job{activeJobs !== 1 ? 's' : ''}</span>
            </div>
          )}
          ...
          <div className="status-item">
            {isConnected ? (
              ...
              <>
                ...
                <span className="status-text error">Offline</span>
              </>
            )}
          </div>
        </div>
...
export function MiniStatus({ photoCount = 0, isIndexing = false, activeJobs = 0 }: MiniStatusProps) {
  return (
