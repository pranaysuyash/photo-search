        ...
        <div className="p-6 overflow-y-auto max-h-[60vh]">
          ...
          <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            ...
            <ul className="text-sm text-blue-700 dark:text-blue-400 space-y-1">
              <li>• Press <kbd className="px-1 py-0.5 text-xs bg-blue-100 dark:bg-blue-800 rounded">?</kbd> anytime to show this help</li>
              <li>• Most shortcuts work globally except when typing in inputs</li>
              <li>• Use <kbd className="px-1 py-0.5 text-xs bg-blue-100 dark:bg-blue-800 rounded">Escape</kbd> to close modals or clear selection</li>
