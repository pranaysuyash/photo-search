                      ...
                      <div className="flex gap-2">
                        {['light', 'dark', 'system'].map(theme => (
                          ...
                          >
                            ...
                            {theme === 'system' && <Settings className="w-4 h-4" />}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="flex items-center gap-3">
                      <input
                        ...
                        onChange={(e) => updatePreference('showMetadata', e.target.checked)}
                        className="rounded"
                      />
                      <span className="text-sm">Show photo metadata overlay</span>
                    </label>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updatePreference('autoplaySpeed', Number(e.target.value))}
                      className="w-full"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  <label className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">Help improve PhotoVault by sharing anonymous usage data</div>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">Automatically send crash reports to help fix issues</div>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">Save search history for suggestions</div>
                    </div>
                  </label>
                ...
                <div className="space-y-4">
                  <label className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">Show system notifications for important events</div>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">Play sounds for actions and notifications</div>
                    </div>
                  </label>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <label className="flex items-center gap-3">
                    <input
                      ...
                      onChange={(e) => updatePreference('enableCache', e.target.checked)}
                      className="rounded"
                    />
                    <div>
                      <div className="text-sm font-medium">Enable Caching</div>
                      <div className="text-xs text-gray-500">Cache images for faster loading</div>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">Load nearby images in advance</div>
                    </div>
                  </label>
                ...
                <div className="space-y-4">
                  ...
                  <label className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">Increase text size throughout the app</div>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">Enable keyboard navigation and shortcuts</div>
                    </div>
                  </label>
