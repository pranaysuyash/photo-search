...
import { Camera, CameraOff, RotateCw, Flashlight, Image as ImageIcon } from 'lucide-react'
  ...
  if (!isSupported) {
    return (
      <div className={`p-4 bg-gray-100 rounded-lg text-center ${className}`}>
        ...
        <p className="text-gray-600 mb-3">Camera not supported on this device</p>
    ...
    <div className="fixed bottom-4 left-4 right-4 bg-blue-600 text-white p-4 rounded-lg shadow-lg z-50">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm opacity-90">Get the best experience with our mobile app</p>
        </div>
