    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-4xl w-full max-h-[80vh] overflow-hidden shadow-2xl">
        ...
        <div className="p-6 overflow-y-auto max-h-[60vh]">
                      ...
                      <div className="flex items-center gap-1">
                        {shortcut.keys.map((key, kidx) => (
                          <React.Fragment key={kidx}>
                            {kidx > 0 && <span className="text-xs text-gray-400">+</span>}
          ...
          <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            ...
            <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
              <li>• Press <kbd className="px-1 py-0.5 bg-white dark:bg-gray-700 rounded text-xs">?</kbd> anytime to see these shortcuts</li>
              <li>• Use <kbd className="px-1 py-0.5 bg-white dark:bg-gray-700 rounded text-xs">{formatKey('cmd')} Shift P</kbd> to access any feature quickly</li>
              <li>• Combine shortcuts for faster workflows (select + action)</li>
        ...
        <div className="p-4 border-t dark:border-gray-700 flex items-center justify-between text-sm text-gray-500">
          <span>
            Using {currentOS === 'mac' ? 'Mac' : 'Windows'} shortcuts
          </span>
          <button
            onClick={onClose}
