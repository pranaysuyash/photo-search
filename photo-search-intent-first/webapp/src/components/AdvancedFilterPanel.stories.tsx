...
export const Default: Story = {
  args: {
    ...
    availableCameras: ["Canon EOS R5", "Sony A7R IV", "Nikon D850", "Fujifilm X-T4"],
    availableCollections: ["Vacation 2023", "Family Photos", "Work Events", "Nature"],
    popularPersons: ["John Doe", "Jane Smith", "Bob Johnson", "Alice Williams"],
    popularColors: ["#FF0000", "#00FF00", "#0000FF", "#FFFF00", "#FF00FF", "#00FFFF"],
    yearRange: [2023, 2020],
