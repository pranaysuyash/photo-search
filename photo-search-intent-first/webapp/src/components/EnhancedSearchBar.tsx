...
const EnhancedSearchBar: React.FC<EnhancedSearchBarProps> = ({
  ...
  const defaultSuggestions: SearchSuggestion[] = [
    { type: 'ai', text: 'Find photos with mountains and sunset', icon: Sparkles },
  ...
  }, [showSuggestions, displaySuggestions, selectedSuggestionIndex, onChange, onSearch, value]);
  ...
  return (
    <div className={clsx('relative w-full max-w-3xl', className)}>
            ...
            <div className="absolute left-5 flex items-center pointer-events-none">
              <motion.div
                ...
                transition={{
                  ...
                  rotate: { repeat: isSearching ? Infinity : 0, duration: 2, ease: 'linear' }
                }}
              >
                {isSearching ? (
            ...
            <input
              ...
              className={clsx(
                ...
                'transition-all duration-200 outline-none',
                {
                  ...
                  'border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600': !isFocused,
                }
              )}
            />
            ...
            <div className="absolute right-2 flex items-center gap-2">
              ...
              <motion.button
                ...
                className={clsx(
                  ...
                  {
                    'bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg shadow-blue-500/25': showFilters,
                    'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600': !showFilters,
                  }
                )}
              >
      ...
      >
        {['All', 'Today', 'This Week', 'Favorites', 'People', 'Places'].map((filter, index) => (
          <motion.button
            key={filter}
          ...
          >
            {filter === 'Favorites' && <Heart className="w-3 h-3 mr-1 inline" />}
            {filter === 'People' && <User className="w-3 h-3 mr-1 inline" />}
            {filter === 'Places' && <MapPin className="w-3 h-3 mr-1 inline" />}
            {filter}
          </motion.button>
        ))}
      </motion.div>
