...
export function Welcome({ onStartDemo, onSelectFolder, onClose }: WelcomeProps) {
  return (
      ...
      >
        <div className="p-8">
          <div className="text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-4">Find any photo instantly</h1>
            <p className="text-gray-600 mb-8 max-w-xl mx-auto">
              Just describe what you're looking for - like "that beach sunset" or "my daughter's birthday" - 
              and we'll find it. No more endless scrolling!
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 text-left">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Search naturally</h3>
                <p className="text-gray-600 text-sm">
                  Type what you remember - "kids at the park" or "that amazing sunset" - we'll find it.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 text-left">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Find people instantly</h3>
                <p className="text-gray-600 text-sm">
                  We recognize faces so you can find all photos of someone special in seconds.
                </p>
              </div>
            </div>
