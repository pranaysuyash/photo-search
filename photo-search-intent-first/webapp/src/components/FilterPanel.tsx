...
import { X, Filter, Sliders, Zap, Save, FolderOpen, Trash2 } from 'lucide-react';
import { QuickFilters } from './QuickFilters';
import { FilterPreset, createFilterPreset, applyFilterPreset } from '../models/FilterPreset';
...
export function FilterPanel({
  ...
  const handleSavePreset = () => {
    ...
    const preset = createFilterPreset(newPresetName.trim(), getCurrentFilters());
    onSavePreset(preset);
    setNewPresetName('');
            ...
            <div className="space-y-4">
              ...
              {filterPresets.length === 0 ? (
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-sm mt-1">Save your filter combinations for quick access</p>
                </div>
              ) : (
                <div className="space-y-2">
                  {filterPresets.map((preset) => (
                    <div key={preset.id} className="border rounded p-3 hover:bg-gray-50">
