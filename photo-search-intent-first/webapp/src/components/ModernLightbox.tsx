...
const ModernLightbox: React.FC<ModernLightboxProps> = ({
  ...
  const [showThumbnailBar, setShowThumbnailBar] = useState(showThumbnails);
  ...
  }, [isOpen, currentIndex, showSidebar]);
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="text-white">
                <h2 className="text-lg font-semibold">{currentPhoto.title || 'Untitled'}</h2>
              ...
              {showInfo && (
                <motion.button
                  ...
                  className={clsx(
                    ...
                    showSidebar ? 'bg-blue-500' : 'bg-white/10 hover:bg-white/20'
                  )}
                >
                  ...
                  <div className="flex items-center gap-1">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.8 }}
                        onClick={() => onPhotoAction?.('rate', { ...currentPhoto, rating: star })}
                        className="text-yellow-400"
                      >
                        <Star className={clsx('w-5 h-5', {
                          'fill-current': currentPhoto.rating && currentPhoto.rating >= star
                        })} />
                      </motion.button>
                    ))}
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  {currentPhoto.people && currentPhoto.people.length > 0 && (
                    <div className="flex items-center gap-3 text-white/70">
                      ...
                      <span className="text-sm">{currentPhoto.people.join(', ')}</span>
                    </div>
                  )}
                  ...
                  <div className="space-y-3">
                    ...
                    {currentPhoto.aperture && (
                      <div className="flex items-center gap-3 text-white/70">
                        ...
                        <span className="text-sm">f/{currentPhoto.aperture}</span>
                      </div>
                    )}
                    ...
                    {currentPhoto.shutterSpeed && (
                      <div className="flex items-center gap-3 text-white/70">
                        ...
                        <span className="text-sm">{currentPhoto.shutterSpeed}s</span>
                      </div>
                    )}

                    {currentPhoto.iso && (
                      <div className="flex items-center gap-3 text-white/70">
                        <span className="text-xs font-bold text-white/50">ISO</span>
