...
export const NoResultsEmpty: React.FC<{ onSearch?: () => void }> = ({ onSearch }) => (
  <EmptyState
    icon={
...
export const NoPhotosEmpty: React.FC<{ onIndex?: () => void }> = ({ onIndex }) => (
  <EmptyState
    icon={
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const NoCollectionsEmpty: React.FC<{ onCreate?: () => void }> = ({ onCreate }) => (
  <EmptyState
    icon={
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
