...
const ModernSidebar: React.FC<ModernSidebarProps> = ({
  ...
  const mainItems: SidebarItem[] = [
    { id: 'library', label: 'All Photos', icon: Grid, count: stats.totalPhotos },
  ...
  const organizationItems: SidebarItem[] = [
    { id: 'collections', label: 'Collections', icon: FolderOpen, count: stats.collections },
    ...
    return (
      <motion.button
        ...
        className={clsx(
          ...
          {
            'bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg shadow-blue-500/25': isActive,
            'text-gray-600 dark:text-gray-400 hover:bg-gray-100/80 dark:hover:bg-gray-800/50': !isActive,
          }
        )}
      >
              ...
              {count && (
                <span className={clsx(
                  'text-xs px-2 py-1 rounded-full font-medium',
                  {
                    ...
                    'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400': !isActive,
                  }
                )}>
                  {count}
                </span>
          ...
          <div className="flex items-center gap-4">
            ...
            {!isCollapsed && (
              ...
              >
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">AI-Powered Management</p>
              </motion.div>
            )}
          </div>
        </div>
          ...
          >
            <div className="bg-gradient-to-br from-emerald-50 via-blue-50 to-purple-50 dark:from-emerald-900/20 dark:via-blue-900/20 dark:to-purple-900/20 rounded-2xl p-4 border border-emerald-200/50 dark:border-emerald-700/50">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-sm font-semibold text-emerald-700 dark:text-emerald-300">AI System Ready</span>
              </div>
              <div className="grid grid-cols-2 gap-3 text-xs">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-600 dark:text-gray-400">{aiStatus.fastIndexType}</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-600 dark:text-gray-400">{aiStatus.freeSpace}GB</span>
